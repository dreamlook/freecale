...
void ov7725_eagle_port_init()
{
    ...
    port_init(PTC10, ALT1 | DMA_FALLING | PULLDOWN );         //PCLK

    port_init(PTC12, ALT1 | IRQ_RISING  | PULLDOWN | PF);     //场中断，上拉，上降沿触发中断，带滤波
